...
void main() {
  ...
  group('LoginPage Widget Tests', () {
    testWidgets('Should display login form fields and title', (WidgetTester tester) async {
    ...
    testWidgets('Should show error SnackBar on invalid credentials', (WidgetTester tester) async {
      await tester.pumpWidget(makeTestableWidget(const LoginPage()));
    ...
    testWidgets('Should navigate to HomePage on valid credentials', (WidgetTester tester) async {
      await tester.pumpWidget(makeTestableWidget(const LoginPage()));
