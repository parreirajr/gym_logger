...
void main() {
  ...
  group('HomePage – US1: View Logged Workouts', () {
    ...
    testWidgets('Should render a WorkoutTile when a workout is returned from the form',
        (WidgetTester tester) async {
      await tester.pumpWidget(makeTestableWidget(
        extraRoutes: {
    ...
    testWidgets('Should render multiple tiles when multiple results are returned',
        (WidgetTester tester) async {
      int idCounter = 0;
      await tester.pumpWidget(makeTestableWidget(
        extraRoutes: {
          '/workout_form': (context) => Scaffold(
                body: ElevatedButton(
                  onPressed: () {
                    idCounter++;
                    Navigator.pop(
                        context, mockWorkout.copyWith(id: 'id-$idCounter'));
                  },
                  child: const Text('Save'),
                ),
              ),
    ...
    testWidgets('Should update an existing tile when an edited workout is returned',
        (WidgetTester tester) async {
