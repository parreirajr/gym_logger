...
void main() {
  group('WorkoutFormPage Widget Tests', () {
    testWidgets('Should display all required form fields', (
      ...
      await tester.pumpWidget(const MaterialApp(home: WorkoutFormPage()));
    ...
    testWidgets('Should successfully return a Workout object when valid', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('Should pre-fill fields and retain ID when in edition mode', (
      WidgetTester tester,
    ) async {
